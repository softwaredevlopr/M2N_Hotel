 ...
 * scrolls past the hero and hides while the contact/booking section is in view
 * (so it never overlaps the actual booking form).
 */
export default function StickyBookCTA({ targetId = "contact" }) {
