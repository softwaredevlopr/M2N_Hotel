...
export default function Hero({ hotel }) {
  ...
  return (
    <section
      id="home"
      className="relative -mt-[68px] flex min-h-screen items-center justify-center overflow-hidden lg:-mt-[76px]"
    >
      <div
      ...
      <div className="relative z-10 mx-auto max-w-5xl px-6 pt-32 pb-24 text-center">
        <div className="flex items-center justify-center gap-4 mb-8">
          <span className="h-px w-12 bg-[#E2484F]/50" />
          <span className="text-xs tracking-[0.45em] uppercase text-[#E2484F]">
            {eyebrow}
          </span>
          <span className="h-px w-12 bg-[#E2484F]/50" />
        </div>
        ...
        <h1 className="font-display text-5xl sm:text-6xl lg:text-7xl xl:text-8xl leading-[1.05] text-cream">
          {main}
          <br />
          <span className="text-[#E2484F]">{accent}</span>
        </h1>
