...
const DEFAULT_DESCRIPTION =
  "On the heritage spine of MI Road, M2N Hotel pairs Rajasthani craft with quiet modern luxury — rooftop dining under Jaipur's sky, curated city journeys, and warm thali welcomes at every arrival.";
...
export default function Hero({ hotel }) {
  ...
  const eyebrow = hotel
    ? `${hotel.name} · ${hotel.city || "Jaipur"}`
    : "M2N Hotel · Jaipur";
  const address = formatShortAddress(hotel) || "MI Road, Panch Batti · Jaipur 302001";

  return (
    <section
      id="home"
      className="relative -mt-[88px] flex min-h-screen items-center justify-center overflow-hidden"
    >
      <div
      ...
      <div className="relative z-10 mx-auto max-w-5xl px-6 pt-32 pb-24 text-center">
        ...
        <div className="mt-12 flex flex-col sm:flex-row items-center justify-center gap-4">
          <a
            href="#contact"
            className="group inline-flex items-center justify-center bg-gold px-9 py-4 text-sm tracking-[0.25em] uppercase text-ink hover:bg-gold-soft transition-colors w-full sm:w-auto"
          >
            Book Your Stay
          </a>
          <a
